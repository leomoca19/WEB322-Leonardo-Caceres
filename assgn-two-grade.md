...
| ---------------------------------- | ------ | --- |
| Styling                            |        |     |
| - Styling with Bootstrap/Tailwind  | 5      | 4   |
...
Leo this is fanstastic work. Excellent how you have incorporated some of the refactorings we talked about. Trivial marks taken off for styling. I mentioned it this wasn't a major part of the assignment but I think if you took a quick look at some of the bootstrap documents you could find ways to quickly fix alignment of the form and perhaps the list.

Overall really please with this. Nice job!
